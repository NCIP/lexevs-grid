...
public class LexEVSDataServiceAuthorization implements PDP {
	...
	public void authorizeRegisterSecurityToken(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("registerSecurityToken")){
			authorizeRegisterSecurityToken(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
