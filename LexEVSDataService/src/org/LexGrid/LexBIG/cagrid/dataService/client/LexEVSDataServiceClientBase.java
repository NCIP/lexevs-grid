 ...
 */
public abstract class LexEVSDataServiceClientBase extends ServiceSecurityClient {	
	...
	public LexEVSDataServiceClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public LexEVSDataServiceClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected LexEVSDataServicePortType createPortType() throws RemoteException {

		LexEVSDataServiceAddressingLocator locator = new LexEVSDataServiceAddressingLocator();
		...
		LexEVSDataServicePortType port = null;
		try {
			port = locator.getLexEVSDataServicePortTypePort(getEndpointReference());
		} catch (Exception e) {
