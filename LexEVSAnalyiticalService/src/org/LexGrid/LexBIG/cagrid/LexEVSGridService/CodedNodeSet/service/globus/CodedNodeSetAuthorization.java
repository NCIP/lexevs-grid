...
public class CodedNodeSetAuthorization implements PDP {
	...
	public void authorizeResolveToList(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeIsCodeInSet(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeRestrictToMatchingDesignations(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeResolve(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeRestrictToStatus(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeDifference(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeRestrictToProperties(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeRestrictToMatchingProperties(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("resolveToList")){
			authorizeResolveToList(peerSubject, context, operation);
			return true;
			...
			authorizeIsCodeInSet(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("restrictToMatchingDesignations")){
			authorizeRestrictToMatchingDesignations(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("resolve")){
			authorizeResolve(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("restrictToStatus")){
			authorizeRestrictToStatus(peerSubject, context, operation);
			return true;
			...
			authorizeDifference(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("restrictToProperties")){
			authorizeRestrictToProperties(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("restrictToMatchingProperties")){
			authorizeRestrictToMatchingProperties(peerSubject, context, operation);
			return true;
