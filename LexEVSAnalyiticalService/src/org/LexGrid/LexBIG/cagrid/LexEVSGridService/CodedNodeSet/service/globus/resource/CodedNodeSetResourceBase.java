 ...
 * 
 */
public abstract class CodedNodeSetResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(CodedNodeSetResourceBase.class);

	private CodedNodeSetResourceConfiguration configuration;
    ...
    public CodedNodeSetResourceBase() {
    }
	...
	public CodedNodeSetResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (CodedNodeSetResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
