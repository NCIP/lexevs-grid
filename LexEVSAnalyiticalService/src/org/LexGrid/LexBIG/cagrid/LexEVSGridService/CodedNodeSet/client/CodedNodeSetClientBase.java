 ...
 */
public abstract class CodedNodeSetClientBase extends ServiceSecurityClient {	
	...
	public CodedNodeSetClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public CodedNodeSetClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected CodedNodeSetPortType createPortType() throws RemoteException {
