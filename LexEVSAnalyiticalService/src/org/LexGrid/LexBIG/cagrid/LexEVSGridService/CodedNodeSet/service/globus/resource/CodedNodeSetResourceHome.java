...
public class CodedNodeSetResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		CodedNodeSetResource resource = (CodedNodeSetResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		CodedNodeSetResourceProperties props = new CodedNodeSetResourceProperties();
        ...
        resource.initialize(props, CodedNodeSetConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.LexGrid.LexBIG.cagrid.LexEVSGridService.CodedNodeSet.stubs.types.CodedNodeSetReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public CodedNodeSetResource getResource(ResourceKey key) throws ResourceException {
		CodedNodeSetResource thisResource = (CodedNodeSetResource)find(key);
		return thisResource;
	}
    ...
    public CodedNodeSetResource getAddressedResource() throws Exception {
        CodedNodeSetResource thisResource;
        thisResource = (CodedNodeSetResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
