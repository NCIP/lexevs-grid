...
import org.LexGrid.LexBIG.cagrid.LexEVSGridService.LexBIGServiceMetadata.common.LexBIGServiceMetadataConstants;
import org.LexGrid.LexBIG.cagrid.LexEVSGridService.LexBIGServiceMetadata.stubs.LexBIGServiceMetadataResourceProperties;
 ...
 * 
 */
public class LexBIGServiceMetadataResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		LexBIGServiceMetadataResource resource = (LexBIGServiceMetadataResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		LexBIGServiceMetadataResourceProperties props = new LexBIGServiceMetadataResourceProperties();
        ...
        resource.initialize(props, LexBIGServiceMetadataConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.LexGrid.LexBIG.cagrid.LexEVSGridService.LexBIGServiceMetadata.stubs.types.LexBIGServiceMetadataReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public LexBIGServiceMetadataResource getResource(ResourceKey key) throws ResourceException {
		LexBIGServiceMetadataResource thisResource = (LexBIGServiceMetadataResource)find(key);
		return thisResource;
	}
