...
public class LexBIGServiceMetadataAuthorization implements PDP {
	...
	public void authorizeListCodingSchemes(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeRestrictToCodingScheme(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeRestrictToPropertyParents(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeRestrictToValue(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			authorizeListCodingSchemes(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("restrictToCodingScheme")){
			authorizeRestrictToCodingScheme(peerSubject, context, operation);
			return true;
			...
			authorizeRestrictToPropertyParents(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("restrictToValue")){
			authorizeRestrictToValue(peerSubject, context, operation);
			return true;
