 ...
 * 
 */
public abstract class LexBIGServiceMetadataResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(LexBIGServiceMetadataResourceBase.class);
	...
	public LexBIGServiceMetadataResourceConfiguration getConfiguration() {
		...
		servicePath+="/LexBIGServiceMetadata";
		...
		try {
			...
			this.configuration = (LexBIGServiceMetadataResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
