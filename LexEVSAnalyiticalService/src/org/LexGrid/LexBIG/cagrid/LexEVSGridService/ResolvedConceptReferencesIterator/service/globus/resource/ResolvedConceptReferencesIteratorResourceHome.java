...
public class ResolvedConceptReferencesIteratorResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		ResolvedConceptReferencesIteratorResource resource = (ResolvedConceptReferencesIteratorResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		ResolvedConceptReferencesIteratorResourceProperties props = new ResolvedConceptReferencesIteratorResourceProperties();
        ...
        resource.initialize(props, ResolvedConceptReferencesIteratorConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.LexGrid.LexBIG.cagrid.LexEVSGridService.ResolvedConceptReferencesIterator.stubs.types.ResolvedConceptReferencesIteratorReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public ResolvedConceptReferencesIteratorResource getResource(ResourceKey key) throws ResourceException {
		ResolvedConceptReferencesIteratorResource thisResource = (ResolvedConceptReferencesIteratorResource)find(key);
		return thisResource;
	}
    ...
    public ResolvedConceptReferencesIteratorResource getAddressedResource() throws Exception {
        ResolvedConceptReferencesIteratorResource thisResource;
        thisResource = (ResolvedConceptReferencesIteratorResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
