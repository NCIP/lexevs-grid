 ...
 */
public abstract class ResolvedConceptReferencesIteratorClientBase extends ServiceSecurityClient {	
	...
	public ResolvedConceptReferencesIteratorClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public ResolvedConceptReferencesIteratorClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected ResolvedConceptReferencesIteratorPortType createPortType() throws RemoteException {
		...
		try {
			port = locator.getResolvedConceptReferencesIteratorPortTypePort(getEndpointReference());
		} catch (Exception e) {
