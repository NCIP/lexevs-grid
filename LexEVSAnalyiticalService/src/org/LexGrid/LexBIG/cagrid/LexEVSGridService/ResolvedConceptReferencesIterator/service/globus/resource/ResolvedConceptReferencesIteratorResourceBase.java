 ...
 * 
 */
public abstract class ResolvedConceptReferencesIteratorResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(ResolvedConceptReferencesIteratorResourceBase.class);

	private ResolvedConceptReferencesIteratorResourceConfiguration configuration;
	...
	public ResolvedConceptReferencesIteratorResourceConfiguration getConfiguration() {
		...
		servicePath+="/ResolvedConceptReferencesIterator";
		...
		try {
			...
			this.configuration = (ResolvedConceptReferencesIteratorResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
