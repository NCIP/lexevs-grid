...
public class FilterResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		FilterResource resource = (FilterResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		FilterResourceProperties props = new FilterResourceProperties();
        ...
        resource.initialize(props, FilterConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.LexGrid.LexBIG.cagrid.LexEVSGridService.Filter.stubs.types.FilterReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public FilterResource getResource(ResourceKey key) throws ResourceException {
		FilterResource thisResource = (FilterResource)find(key);
		return thisResource;
	}
    ...
    public FilterResource getAddressedResource() throws Exception {
        FilterResource thisResource;
        thisResource = (FilterResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
