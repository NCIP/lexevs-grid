 ...
 * 
 */
public abstract class FilterResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(FilterResourceBase.class);

	private FilterResourceConfiguration configuration;
	...
	public FilterResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (FilterResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
