 ...
 */
public abstract class CodedNodeGraphClientBase extends ServiceSecurityClient {	
	...
	public CodedNodeGraphClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public CodedNodeGraphClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected CodedNodeGraphPortType createPortType() throws RemoteException {

		CodedNodeGraphServiceAddressingLocator locator = new CodedNodeGraphServiceAddressingLocator();
		...
		CodedNodeGraphPortType port = null;
		try {
			port = locator.getCodedNodeGraphPortTypePort(getEndpointReference());
		} catch (Exception e) {
