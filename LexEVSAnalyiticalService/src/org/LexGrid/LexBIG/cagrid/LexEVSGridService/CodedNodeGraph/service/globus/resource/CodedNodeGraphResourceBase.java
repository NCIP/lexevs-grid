 ...
 * 
 */
public abstract class CodedNodeGraphResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(CodedNodeGraphResourceBase.class);

	private CodedNodeGraphResourceConfiguration configuration;
    ...
    public CodedNodeGraphResourceBase() {
    }
	...
	public CodedNodeGraphResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (CodedNodeGraphResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
