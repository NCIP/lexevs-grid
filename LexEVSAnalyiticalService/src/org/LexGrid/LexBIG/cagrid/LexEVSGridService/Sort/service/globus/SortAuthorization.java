 ...
 * 
 */
public class SortAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://LexBIGCaGridServices.cagrid.LexBIG.LexGrid.org/LexBIGCaGridServices/Sort";
	
	
	public SortAuthorization() {
	}
	...
	public static void authorizeGetName() throws RemoteException {
		
		
	}
					
	public static void authorizeGetDescription() throws RemoteException {
		
		
	}
					
	public static void authorizeGetProvider() throws RemoteException {
		
		
	}
					
	public static void authorizeGetVersion() throws RemoteException {
