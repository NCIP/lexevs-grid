...
public abstract class SortClientBase extends ServiceSecurityClient {	
	...
	public SortClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public SortClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	private SortPortType createPortType() throws RemoteException {

		SortServiceAddressingLocator locator = new SortServiceAddressingLocator();
		...
		SortPortType port = null;
		try {
			port = locator.getSortPortTypePort(getEndpointReference());
		} catch (Exception e) {
