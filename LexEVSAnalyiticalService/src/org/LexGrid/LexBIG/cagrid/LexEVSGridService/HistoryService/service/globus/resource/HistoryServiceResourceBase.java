 ...
 * 
 */
public abstract class HistoryServiceResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(HistoryServiceResourceBase.class);
	...
	public HistoryServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (HistoryServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
