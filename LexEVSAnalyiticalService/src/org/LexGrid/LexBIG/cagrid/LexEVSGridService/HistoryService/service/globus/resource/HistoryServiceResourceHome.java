...
public class HistoryServiceResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		HistoryServiceResource resource = (HistoryServiceResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		HistoryServiceResourceProperties props = new HistoryServiceResourceProperties();
        ...
        resource.initialize(props, HistoryServiceConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public org.LexGrid.LexBIG.cagrid.LexEVSGridService.HistoryService.stubs.types.HistoryServiceReference getResourceReference(ResourceKey key) throws Exception {
 	...
 	*/	
	public HistoryServiceResource getResource(ResourceKey key) throws ResourceException {
		HistoryServiceResource thisResource = (HistoryServiceResource)find(key);
		return thisResource;
	}
    ...
    public HistoryServiceResource getAddressedResource() throws Exception {
        HistoryServiceResource thisResource;
        thisResource = (HistoryServiceResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
