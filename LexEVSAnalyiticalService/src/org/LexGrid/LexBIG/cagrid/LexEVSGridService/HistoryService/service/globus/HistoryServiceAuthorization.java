...
public class HistoryServiceAuthorization implements PDP {
	...
	public static void authorizeGetAncestors() throws RemoteException {
		
		
	}
					
	public static void authorizeGetBaselines() throws RemoteException {
		
		
	}
					
	public static void authorizeGetConceptChangeVersions() throws RemoteException {
		
		
	}
					
	public static void authorizeGetConceptCreationVersion() throws RemoteException {
		
		
	}
					
	public static void authorizeGetDescendents() throws RemoteException {
		
		
	}
					
	public static void authorizeGetEarliestBaseline() throws RemoteException {
		
		
	}
					
	public static void authorizeGetEditActionList() throws RemoteException {
		
		
	}
					
	public static void authorizeGetEditActionList2() throws RemoteException {
		
		
	}
					
	public static void authorizeGetEditActionList3() throws RemoteException {
		
		
	}
					
	public static void authorizeGetLatestBaseline() throws RemoteException {
		
		
	}
					
	public static void authorizeGetSystemRelease() throws RemoteException {
