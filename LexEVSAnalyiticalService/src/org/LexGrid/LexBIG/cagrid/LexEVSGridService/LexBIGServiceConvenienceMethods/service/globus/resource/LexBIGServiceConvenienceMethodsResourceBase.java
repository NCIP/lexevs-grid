 ...
 * 
 */
public abstract class LexBIGServiceConvenienceMethodsResourceBase extends ReflectionResource implements Resource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(LexBIGServiceConvenienceMethodsResourceBase.class);

	private LexBIGServiceConvenienceMethodsResourceConfiguration configuration;
    ...
    public LexBIGServiceConvenienceMethodsResourceBase() {
    }
	...
	public LexBIGServiceConvenienceMethodsResourceConfiguration getConfiguration() {
		...
		servicePath+="/LexBIGServiceConvenienceMethods";
		...
		try {
			...
			this.configuration = (LexBIGServiceConvenienceMethodsResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
