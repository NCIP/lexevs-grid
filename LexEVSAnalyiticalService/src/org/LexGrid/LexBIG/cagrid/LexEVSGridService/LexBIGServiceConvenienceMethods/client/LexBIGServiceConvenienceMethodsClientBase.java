 ...
 */
public abstract class LexBIGServiceConvenienceMethodsClientBase extends ServiceSecurityClient {	
	...
	public LexBIGServiceConvenienceMethodsClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public LexBIGServiceConvenienceMethodsClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected LexBIGServiceConvenienceMethodsPortType createPortType() throws RemoteException {
		...
		try {
			port = locator.getLexBIGServiceConvenienceMethodsPortTypePort(getEndpointReference());
		} catch (Exception e) {
